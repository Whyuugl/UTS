            ...
            <div class="card-body">
                <form action="/insertpasien" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="norm" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Keluhan</label>
                        <input type="text" name="keluhan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Diagnosa</label>
                        <input type="text" name="diagnosa" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="terapi" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="hb" aria-label="HB" class="form-control">
                            <input type="text" name="gd" aria-label="GD" class="form-control">
                          </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="au" aria-label="AU" class="form-control">
                            <input type="text" name="co" aria-label="CO" class="form-control">
                          </div>
                    </div>
